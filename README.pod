...
Dancer::Session::Redis::Simple - Redis backend for Dancer Session Engine with in memory hash for local reads
...
L<https://github.com/mgreen86/Dancer-Session-Redis/pulls>
